# -*- coding: utf-8 -*-
# This file was *autogenerated* from the file sage_gugu_main.sage.
from sage.all_cmdline import *   # import sage library
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_9 = Integer(9); _sage_const_999 = Integer(999); _sage_const_100p0 = RealNumber('100.0'); _sage_const_12 = Integer(12); _sage_const_11 = Integer(11); _sage_const_121 = Integer(121); _sage_const_15 = Integer(15); _sage_const_992 = Integer(992); _sage_const_991 = Integer(991); _sage_const_21 = Integer(21)
"""
...
class login_sys():
        ...
        if os.path.isfile( file_path_name):
            with open(file_path_name, "r") as myfile:
                ...
                for line in lines:
                    ...
                    words[_sage_const_5 ] = float( words[_sage_const_5 ])
            ...
            words_all.sort( key = operator.itemgetter(_sage_const_5 ))
            for idx, words in enumerate(words_all):
                if idx < _sage_const_15 :
                    # "랭킹: 0번호, 1이름, 2점수, 3갯수, 4총시간(초), 5단위시간(초)"
                    words[_sage_const_5 ] = str(words[_sage_const_5 ])
                    line = ",".join( words)
                    print idx+_sage_const_1 , "순위: ", line
                else:
                    break
            print
        else:
    ...
    def show_sel_item(self, sel_item):
        ...
        if os.path.isfile( file_path_name):
            ...
            print "TOP-15위까지만 보여줍니다."
            print "랭킹: 0번호, 1이름, 2점수, 3갯수, 4총시간(초), 5단위시간(초)"
            words_all = [x for x in words_all if int(x[_sage_const_0 ]) == sel_item]
            words_all.sort( key = operator.itemgetter(_sage_const_5 ))
            for idx, words in enumerate(words_all):
                if idx < _sage_const_15 :
                    # "랭킹: 0번호, 1이름, 2점수, 3갯수, 4총시간(초), 5단위시간(초)"
    ...
    def show_nosort(self):
        ...
        with open("score.txt", "r") as myfile:
            ...
            for line in lines:
                print line,
                words = line.split(',')
                print "{}의 시간 = {}".format( words[_sage_const_1 ], words[_sage_const_5 ])
                words_all.append( words)
            print
                
#========================================================================

def ask_q_login(ask_q, N, user_log, sel_item = _sage_const_1 ):
    """
    추가할 기능
    ...
    if score != _sage_const_0 :
        time_each = time_all / (N * score / _sage_const_100p0 )
    ...
    if N >= _sage_const_2  and score != _sage_const_0 :   
...
def SAGE_main():
    ...
    print
    SAGE_ask_root_2bc( _sage_const_1 )   
    

def _gugu_basic_r0():  

    level = _sage_const_0 
    while level != _sage_const_9 :
        ...
        elif level == _sage_const_1 :
            print "레벨-1: 구구단 테이블을 보여줍니다."
            show_table()
            print
            
        elif level == _sage_const_2 :
            print "레벨-2:한자리 수 곱셈 게임입니다."
            N_prob = int( raw_input("몇 개의 문제를 풀겠습니까? "))
...
def PythonSage_gugu_basic():  
    ...
    while game_finish != True:
        ...
        if len(sel_item) > _sage_const_0 :
            sel_item = int( sel_item)
        else:
            continue
        
        #기본 
        if sel_item == _sage_const_0 :
            print "0번: 구구단 테이블을 보여줍니다."
            show_table()
            print        

        # 곱셈 게임 
        elif sel_item == _sage_const_1 :
